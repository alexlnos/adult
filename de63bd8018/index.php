...
<p> Pero un día me encontré con el blog de un actor porno americano. Revelaba el secreto de las pollas
                    grandes que tienen todos los actores. Utilizan <a class="click-link" href="#orderblock"> pastillas </a> especial para sus penes.
                </p>
...
<center><a class="click-link" href="#orderblock"><img alt="" class="product__img" src="assets/prostazex/img/product2.png"  id="productOne"></a></center>
                     ...
                     <h3 style="text-align: center;margin: 0;"><span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3>
                            ...
                            <form id="buyForm" class="toform orderForm x_order_form buyForm" action="order.php" method="POST">
                                ...
                                <input type='hidden' name='fbpxl' value='<?= $_GET['fbpxl'];?>'>
                                 <label style=" display:block;text-align:center" for="name" class="data_label">Tu nombre:</label>
                                <input class="form-control input-form wheel_input" name="name" id="name" style="color:#000" placeholder="" required>
                                <div>
                                    <label style=" display:block;text-align:center" for="phone" class="data_label">Tu número de teléfono:</label>
                                    <input class="form-control input-form mob1 val2 wheel_input" style="color:#000" name="phone" id="phone" pattern="(?=.*[0-9+]).{7,}" placeholder="" type="tel" maxlength="13" minlength="7" required>
                                    
                                </div>
                                <button type="submit" class="main-link"> ¡Envía tu pedido y llévate tu descuento en Maral Gel!</button>
                            </form>
...
<p style="text-align:center"> <a class="btn click-link" href="#orderblock" style="font-size: 20px;"><b> Aquí tienen el
...
<br/>
<center><a class="btn2 click-link" href="#orderblock" style="font-size: 22px;"> PEDIR ESTAS PASTILLAS </a></center>
<br/>
</div>


<div class="ac_footer">
    <a class="click-link" href="#orderblock">Report</a>
    <p></p>
</div>

<div class="spin-result-wrapper">
    <div class="pop-up-window">
        <a class="click-link" href="#orderblock"><div class="close-popup" style="background-image: url('assets/titan_gel_es/img/cross.svg');"></div></a>
