...
<body>
<!-- wrapper starts -->
<div id="cd_footer_fixed" class="">
  <div style="margin: 0px; padding: 0px;">
    <p>Obtine un discount de<span class="hl">50% acum!</span>. Oferta Se Termină În: <span id="countdownTimer" data-minutes="15" data-seconds="00"></span></p>
    <a href="#form2" target="_blank">Grăbește-mi Comanda</a> </div>
</div>
<style>
#cd_footer_fixed { display:none;}
#cd_footer_fixed.vh {background: rgba(0, 0, 0, 0.68); position: fixed; bottom: 0; left:0px; right:0px; width: 100%; text-align: center; z-index: 999999; padding: 2vw 0; margin: 0px; display:block;}
#cd_footer_fixed.vh p{font-family: Tahoma,Verdana; font-size: 3vw; display: inline-block; color: #fff; margin: 0px 0px 11px; padding: 0px;}
#cd_footer_fixed.vh .hl{color:#e1c231; padding:0 1vw; font-weight:700;}
#cd_footer_fixed.vh a{font-family: Tahoma,Verdana; font-size: 3vw; line-height: 4vw;display: inline-block; color: #fff; padding: 2vw; background: #e31c02; border-radius: 1vw; outline: medium none; text-decoration: underline; margin: 0px 0px 0px 2vw;}
#cd_footer_fixed.vw {background: rgba(0, 0, 0, 0.68); position: fixed; bottom: 0; left:0px; right:0px; width: 100%; text-align: center; z-index: 999999; padding: 2vh 0; margin: 0px; display:block;}
#cd_footer_fixed.vw p{font-family: Tahoma,Verdana; font-size: 3vh; display: inline-block; color: #fff; margin: 0px 0px 11px; padding: 0px;}
#cd_footer_fixed.vw .hl{color:#e1c231; padding:0 1vh; font-weight:700;}
#cd_footer_fixed.vw a{font-family: Tahoma,Verdana; font-size: 3vh; line-height: 4vh;display: inline-block; color: #fff; padding: 2vh; background: #e31c02; border-radius: 1vh; outline: medium none; text-decoration: underline; margin: 0px 0px 0px 2vh;}
...
<script>
    if(document.getElementById('countdownTimer'))
    {
        ...
        function countDown() {
            ...
            if (cd_sec<=9) { cd_sec = "0" + cd_sec; }

            var cd_time = (cd_min<=9 ? "" + cd_min : cd_min) + ":" + cd_sec;

            if (document.getElementById) { document.getElementById('countdownTimer').innerHTML = cd_time; }

            cd_sd = window.setTimeout("countDown();", 1000);
            if (cd_min == '00' && cd_sec == '00') { cd_sec = "00"; window.clearTimeout(cd_sd); }
			cd_inited = true;
        }
...
<div id="wrapper">
  <div class="container">
    <header id="header"> <img src="assets/logo.jpg">
      ...
      <div class="headbeyaz">
        <div class="head"> <span>ȘTIRI <b>+18</b></span>
          <p> NU POȚI ACCESA ACEST SITE WEB <br>
            DACĂ AI SUB 18 ANI</p>
        </div>
      </div>
      <div class="headsag">
        <p>
    ...
    <div class="contentsol">
      ...
      <p> RECOMANDĂ EROMAN </p>
      <b> MAI MULȚI DOCTORI DE RENUME AU RECOMANDAT EROMAN ÎN ULTIMELE 3 LUNI CA TRATAMENT PENTRU <br>
      ...
      <div style="margin-bottom: 25px;">
        <div class="yazi1">
          <p style="width: 48%;"> <img src="assets/il.jpg" style="width: 100%; display: block; max-width: 400px; margin: 10px auto;"> <b> Radu and Ana</b><br>
            Am folosit produsul timp de trei luni. Până la sfârșitul lunii a doua, penisul a crescut cu 6 centimetri. Apoi a încetat să crească. Este acum în jur de 22cm și pot face sex timp de o jumătate de oră fără ejaculare. </p>
          <p style="width: 48%; float: right; overflow: hidden;"> <img src="assets/ir.jpg" style="width: 100%; display: block; max-width: 400px; margin: 10px auto;"> <b> Dragoș. / Constanța </b><br>
            L-am folosit timp de o lună. Un medic mi-a recomandat produsul și a fost puțin dificil de găsit site-ul produsului original. Oricum, penisul meu a crescut mai mult de 4 centimetri, dar asta pentru ca nu folosesc produsul foarte des. Ar trebui să îl folosesc zilnic, dar câteodată uit și sare peste anumite zile. <br>
            <br>
            Dacă găsesc o prietenă în două luni, îi o voi da totul. :) </p>
        </div>
      </div>
      <div class="satici"> <a href="#form2"> <span> AM INVESTIGAT ADEVĂRATUL EROMAN ȘI DISTRIBUITORUL SĂU</span><br>
        <b> CLICK AICI PENTRU ACCES LA DISTRIBUITORUL EROMAN</b><br>
        <b style="font-size: 20px; text-transform: none;"> POȚI LUA ACEST PRODUS CU UN DISCOUNT DE 50% <br>
        VA TREBUI SĂ PLĂTEȘTI DOAR PENTRU TRANSPORT </b> </a> </div>
      ...
      <div style="margin-bottom: 25px;">
        ...
        <div class="yazi1">
          <p> <b> Eduard V. / București </b><br>
            Tot ce pot spune cititorilor este: Vrei să fii fericit? Perfect! Un penis mare? Perfect! Vrei sex peste 1 oră? Perfect! Le poți face pe toate cu acest produs! <br>
            <br>
            Ce poți cere mai mult? Am terminat de pachete. Dar atenție la produsele false. </p>
        </div>
      </div>
      ...
      <div style="margin-bottom: 50px;">
        ...
        <div class="yazi1">
          <p> Tot ce pot spune cititorilor este: Vrei să fii fericit? Perfect! Un penis mare? Perfect! Vrei sex peste 1 oră? Perfect! Le poți face pe toate cu acest produs! <br>
            <br>
            What more could you ask for? I've finished 3 packs. But beware of fake products. </p>
        </div>
      </div>
    ...
    <div class="titanform">
      <div class="titanust"> <span> La fel ca și revista Women's Health, primim o reducere specială pentru cititorii noștri de la distribuitor și o garanție: dacă produsul nu este eficient, există o garanție de 100% pentru rambursarea prețului de achiziție.<b> Această reducere este disponibilă pentru o perioadă limitată de timp. </b></span>
        <div class="link"> <a href="#form2"> <strong> CLICK PENTRU A PRIMI </strong><span> UN DISCOUNT DE 50% </span><strong> PENTRU EROMAN </strong> </div>
        <p><img src="assets/rhino.png"> </a>
        
        <br>
        ULTIMA ZI A PROMOȚIEI:
        <script>dtime_nums(-1, true)</script>
        <br>
        Stocul este limitat din cauza cererii foarte mari.
        </p>
      </div>
    </div>
    ...
    <div style="margin-bottom: 15px;">
      ...
      <div class="yazi1">
        <p> Iată. Cercetările noastre arată că prostituatele solicită de până la 3 ori mai mulți bani de la bărbații care au folosit EROMAN și ale căror penisuri sunt mai mari de 20 cm. <br>
          Ele sunt conștienți de numărul tot mai mare de bărbați care au folosit acest produs în ultimele 6 luni. În timp ce în trecut doar 1 din 10 clienți au avut un penis de 20 cm, acest raport este acum 3 din 10 clienți. </P>
      </div>
    </div>
    <br>
    <center>
      <a href="#form2"><img  id="form2" src="assets/rhino.png"></a>
    </center>
    <br>
    ...
    <p style="" class="ruletka-p">IMPORTANT! <br> Site-ul nostru oferă o reducere suplimentară. Încercați-vă norocul și apăsați butonul „SPIN”. Dacă aveți noroc, puteți comanda produsul la un preț și mai mic! Noroc!
</span></p>
  ...
  <div class="pop-up-window">
    ...
    <span style="color:black" class="pop-up-heading">Felicitări!</span>
    <p class="ruletka-p pop-up-text" style="padding: 15px 15px 20px">Puteți cumpăra produsul cu o reducere de 50%!</p>
...
159ron
  ...
  <form method="post"   class="   orderForm     " id="form">
    <input type="text" class="input-roulette" id="name" style="max-width:100%"  name="name" placeholder="Nume" required><br>

    <input type="tel" class="input-roulette phone-mask" style="max-width:100%"  id="phone" name="phone"   onkeyup="this.value=this.value.replace(/\s/,'')"  minlength="5" required placeholder="Telefon" ><br>
 <input type="hidden" name="sub1" value="{clickid}">

    <input type="submit" name="submit"  style="max-width:100%"  class="submit-roulette" value="CUMPĂRĂ EROMAN">
  </form>
</div>
...
.pop-up-window::after {
  ...
  <div class="contentsag">
    <p> Interviurile cu urologi, efectuate de editorii revistei Women's Health, au descoperit efectul uimitor al EROMAN real în ceea ce privește extinderea penisului.</p>
    <img src="assets/grupsag.jpg"> <strong> Radu S. / Brașov </strong>
    ...
    <p><b><a href="#form2">Cum se obține produsul: Fă clic pentru a obține EROMAN cu discount  &gt;&gt; </a></b></p>
    <a class="buton" href="#form2"> Comandă EROMAN </a> <img src="assets/agizsakso.jpg"> <strong> Alexandru M. / Iași </strong>
    <p>I-am cerut soției să-l aplice pe penisul meu dimineața și seara. Acum suntem amândoi foarte fericiți. Am reușit să obțin o dimensiune medie într-o perioadă scurtă de timp și mă simt foarte împlinită. EROMAN, ești minunat! </p>
    <img src="assets/cibilicibili.jpg"> <strong> Anton C. / Slatina </strong>
    <p> Acum o săptămână, un prieten mi-a spus despre produsul respectiv. Nu a sunat foarte realist. Nu credeam că produsul ar ajuta la mărirea penisului meu și că îmi va îmbunătăți funcția sexuală. Dar atunci când un alt prieten mi-a spus despre același produs, am decis să comand. Rezultatele pe care le-am văzut în prima săptămână m-au surprins. Recomand acest produs eficient. </p>
    <img src="assets/cubuk.jpg"> <strong>Radu / Oradea </strong>
    <p> Soția mea și cu mine aveam unele probleme. Am vizitat medicul să discutăm disfuncția mea sexuală. În acest moment, nu mai este doar pentru plăcere, ci pentru sănătate și am încercat multe alte produse. Nu am vrut să iau pilule periculoase. Printre produsele pe bază de plante pe care le-am testat până în prezent, EROMAN este cel mai bun fără îndoială. Utilizați acest produs și sunt sigur că veți vedea avantajele acestuia. </p>
    <img src="assets/dildo.jpg"> <strong> Cătălin. / Cluj-Napoca</strong>
  ...
  <div class="yorumlar">
    ...
    <div class="faceyorumlars">
      <div class="yorumdis">
        ...
        <div class="faceyazi">
          <p> Andrei Bercea </p>
          <span> Multe mulțumiri producătorilor EROMAN pentru că EROMAN mi-a salvat căsnicia. Sexul obișnuit și plăcut este esențial în căsătorie. În ultimii ani, devenisem mai degrabă prieteni. Cu toate acestea, acum 2 luni am aflat despre EROMAN, iar viața noastră sexuală a făcut o schimbare completă. </span> <img src="assets/p2.jpg"> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 12 zile în urmă </strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum2.jpg"></div>
        <div class="faceyazi">
          <p> Radu Andrei </p>
          <span> Am învățat multe despre mine cu EROMAN. Înainte, penisul meu era de 10 cm și mi-era teamă să mă apropii de fete sau să merg mai departe. În doar o lună, penisul meu a crescut la 18cm și acum pot să mă adresez oricarei fete cu încredere. </span> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 12 zile în urmă </strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum3.jpg"></div>
        <div class="faceyazi">
          <p> Popescu Mihnea </p>
          <span> Am folosit EROMAN în fiecare seară înainte de a merge la culcare. Au trecut 4 săptămâni și penisul meu a crescut deja cu aproximativ 4 cm. Acesta este un adevărat miracol. :) </span> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 11 zile în urmă </strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum4.jpg"></div>
        <div class="faceyazi">
          <p> Tony Popescu </p>
          <span> Penisul meu este mai mare și pot face sex mai mult. Fata mea geme ca o nebună. Vecinii au început să se plângă de zgomot. :) Ea are orgasm de cel puțin 3 ori în fiecare noapte. E chiar mai fericită decât mine cu EROMAN. </span> <strong><span>Îmi place</span> <span> Adaugă un comentariu </span> Cu 10 zile în urmă </strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum5.jpg"></div>
        <div class="faceyazi">
          <p> Theodor Vicor </p>
          <span> Sunt căsătorit de 5 ani și, pentru prima dată, mi-am văzut soția țipând când ea a avut orgasm. EROMAN a adus o nouă dimensiune vieții noastre sexuale. <br>
      ...
      <div class="yorumdis">
        ...
        <div class="faceyazi">
          <p>George Militaru </p>
          <span> Datorită acestei creme, penisul meu este acum mai lung atât în lungime, cât și în circumferință. Cred că grosimea este la fel de importantă ca și lungimea. Îmi pot termina partenerul de 3-4 ori în fiecare noapte. </span> <img src="assets/ba2.jpg"> <strong><span>Îmi place</span> <span> Adaugă un comentariu </span> Cu 6 zile în urmă</strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum27.jpg"></div>
        <div class="faceyazi">
          <p> Răzvan Memron</p>
          <span> Acest produs a fost mult mai bun decât mă așteptam. Când l-am cumpărat pentru prima dată, am avut mari speranțe, iar rezultatele sunt minunate. Puteți vedea diferența dintre imagini. <br>
      ...
      <div class="yorumdis">
        ...
        <div class="faceyazi">
          <p>Anton Mic </p>
          <span> Soția mea are acum probleme cu luarea penisului meu în gură. Puteți vedea singuri. N-am crezut niciodată că aș putea crește atât de mult. <br>
      ...
      <div class="yorumcevap">
        ...
        <div class="faceyazi">
          <p> Mirabela Popescu </p>
          <span> Unele femei au noroc ... Sunt atât de invidioasă. Este foarte mare creșterea... în lungime și circumferință. </span> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 5 zile în urmă </strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum18.jpg"></div>
        <div class="faceyazi">
          <p>Andrei Boss </p>
          <span> Penisul meu este acum mai mare și eu decid când să mă termin. Am uitat totul despre ejacularea prematură. Mă simt ca un rege în pat. </span> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 5 zile în urmă </strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum19.jpg"></div>
        <div class="faceyazi">
          <p> Luca Tomescu </p>
          <span> Acest produs mi-a salvat, practic, căsnicia. Penisul meu este cu 1,5 inch mai lung și mă bucur de el. </span> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 4 zile în urmă </strong> </div>
      </div>
      <div class="yorumcevap">
        <div class="faceresim"><img src="assets/yorum20.jpg"></div>
        <div class="faceyazi">
          <p> Daniel Costi </p>
          <span> Aceasta este o lungire incredibilă! Și, de asemenea, previne ejacularea prematură? Soțul meu suferă de asta, deci intenționez să cumpăr produsul. V-am fi recunoscători dacă mi-ați putea răspunde. </span> <strong><span>Îmi place</span> <span> Adaugă un comentariu </span> Cu 4 zile în urmă </strong> </div>
      </div>
      <div class="yorumcevap">
        <div class="faceresim"><img src="assets/yorum19.jpg"></div>
        <div class="faceyazi">
          <p> Roxana Vancea </p>
          <span> Da, draga mea, soțul meu se termina, de asemenea, în maxim 5 minute. Cu EROMAN, nu l-am văzut cu mai puțin de 20 de minute. În cele din urmă, mă bucur de orgasme reale. </span> <strong><span>Îmi place</span> <span> Adaugă un comentariu </span> Cu 4 zile în urmă</strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum22.jpg"></div>
        <div class="faceyazi">
          <p> Mihai Ertimel </p>
          <span> Producători EROMAN, vă mulțumesc. Mi-ați salvat căsnicia! Dacă cineva vă pune la îndoială, dacă să cumpere sau nu produsul, să știți că nu aveți nicio îndoială. Mi-ați salvat căsnicia și vă recomand tuturor. <img src="assets/p4.jpg"> </span> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 3 zile în urmă</strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum23.jpg"></div>
        <div class="faceyazi">
          <p> Andra Văduvescu </p>
          <span> Am văzut EROMAN pe Twitter. Un cuplu l-a folosit, iar penisul tipului a creascut enorm. După insistența mea constantă, soțul meu a cumpărat produsul în cele din urmă și l-a folosit-o timp de o lună. Astăzi sunt din nou pe site pentru a cumpăra un alt pachet. Îi recomandăm tuturor. Am încercat toate celelalte produse, dar EROMAN este mai bun decât toate. </span> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 2 zile în urmă </strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum24.jpg"></div>
        <div class="faceyazi">
          <p> Antonio Pop </p>
          <span> Nu este nevoie de comentarii. Vă voi adăuga fotografiile, veți judeca voi înșivă. Am folosit produsul timp de o lună și penisul meu a crescut cu aproximativ 4,5 cm. <br>
      ...
      <div class="yorumcevap">
        ...
        <div class="faceyazi">
          <p> Luis Valentin </p>
          <span> Arată foarte bine. Dacă  bărbații care utilizează EROMAN ar arăta rezultatele, astfel încât să nu pierdem timpul cu restul, ar fi perfect. </span> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 2 zile în urmă</strong> </div>
      </div>
      <div class="yorumdis">
        <div class="faceresim"><img src="assets/yorum26.jpg"></div>
        <div class="faceyazi">
          <p> Brad Tedol </p>
          <span> Am cumpărat EROMAN acum o săptâmană și dat fiind faptul că revista oferă o reducere, am cumpărat alte trei pachete. Penisul meu a crescut 2 cm în doar o săptămână. Acest lucru este foarte bun. </span> <strong><span> Îmi place</span> <span> Adaugă un comentariu </span> Cu 1 zi în urmă</strong> </div>
      </div>
      <a class="buton" href="#form2"> Comandă EROMAN </a> </div>
  </div>
</div>
</div>
