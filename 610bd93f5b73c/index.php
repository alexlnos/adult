							...
							<div class="form_wrapper">
								...
								<div class="sec-one-form" id="sec-one-form">
									...
									<div class="sec-one__prices text-center">
										<span class="price-old wv_old-price x_currency_old">₱3,980</span>
										<span class="price-new wv_new-price x_currency">₱1,990</span>
									</div>

									<form name="myForm" method="POST" class="wv_order-form form_order buyForm">
										<input name="data1" type="hidden" value="{clickid}">
                    <input name="data2" type="hidden" value="sm">
										<div class="form-group target_list_wrap">
											<select name="target_geo_hash" id="city" class=" wv_phone form-control js-select" style="-webkit-appearance: none !important;">
												<option value="00000000" data-price="₱1,990" data-old_price="₱3,980" data-country_code="Philippines" data-discount="undefined">Choose country</option>
												<option value="Z1VneA1V" data-price="₱1,990" data-old_price="₱3,980" data-country_code="PH" data-discount="50%">Philippines</option>
											</select>
										</div>
