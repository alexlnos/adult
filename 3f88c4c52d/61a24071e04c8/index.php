        ...
        <div class="productform" id="orderblock">
            <div class="prod-wrap toform">
               ...
               <div style="display: block !important" class="order_block">
                ...
                <form  id="order_form" class="orderForm order_form al-form" action="api.php"   method="POST">

                  <select class="text1 country_select" id="text2" name="country" style="display: none;">
                     <option value="pe">Peru</option>
                  </select>
                        
                     <label for="name" id="name" data-name="name" class="data_label">Tu nombre:</label>
                     <div>
                        ...
                        <div>
                           <input class="wheel_input field" id="phone" data-name="phone" name="phone" placeholder=""  onkeyup="this.value=this.value.replace(/\s/,'')" required type="tel" value="+51">
                        </div>
