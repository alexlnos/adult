        ...
        <div class="productform" id="orderblock">
            <div class="prod-wrap toform">
               ...
               <center>      <img src="assets/prostazex/img/product2.png" width="300" class="prod_img"></center>
                     ...
                     <center><s> S./ 260 </s><br>
                        <i style="color:red;font-size:22px"> S./ 130 </i></center>
                ...
                <form  id="order_form" class="orderForm order_form al-form" action="order.php"   method="POST">
                     ...
                     <div>
                        ...
                        <div>
                           <input class="wheel_input field" id="phone" name="phone" placeholder=""  onkeyup="this.value=this.value.replace(/\s/,'')" required type="text" value="+51">
                        </div>
                      
                        <button class="main-link " id="ordbut" type="submit"> ¡Envía tu pedido y llévate tu descuento en Maral Gel!
                        </button>
                  </form>
                  </div>
                  <style>
