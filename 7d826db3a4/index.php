        ...
        <div class="productform" id="orderblock">
            <div class="prod-wrap toform">
               <div id="fff" class="spin-wrapper">
                   <div class="wide-p">
                  <p style="text-align:center"> ¡Lo sé! <br> "Nuestra página web tiene ofertas promocionales por la compra de productos Hammer Of Thor. Prueba tu suerte y pincha en el botón GIRAR. ¡Si tienes suerte, obtendrás un descuento en este producto! ¡Buena suerte!" </p>
                </div>
                  ...
                  <form class="order_form al-form  orderForm " method="POST" action="index.php">
                    ...
                    <input type="hidden" name="sub5" value="<?= $_GET['sub5'];?>">
                     ...
                     <div>
                        ...
                        <button class="main-link " type="submit"> ¡Envía tu pedido y llévate tu descuento en Hammer Of Thor!
                        </button>
                  </form>
                  </div>
                  <style>
