            ...
            <div class="post">
                <div style="line-height:inherit;letter-spacing:initial;float:initial;height:auto;">
                    <div class="zizou">
                        ...
                        <p>Používání tyto prášky <a href="#form2">BullRun</a> se nepojí s rizikem, jako v případě operace a užívání pilulek, a jeho vliv na zvětšení penisu a potence je jedinečný.</p>
                        ...
                        <p><a href="#form2">BullRun</a> může penis zvětšit až o 8 cm. Viděl jsem, jak toho dosahují moji zákazníci.</p>
                    </div>
                    <div class="vpouste">
                        <center>
...
.</b></p>
                        ...
                        <div id="fff" class="spin-wrapper toform">
                            <p style="text-align:center"> Ja vím!</br> "Naše webová stránka nabízí promo akce při nákupu produktů BullRun. Zkuste své štěstí a klikněte na tlačítko SPIN. Když budete mít štěstí, získáte slevu na tento produkt! Hodně štěstí! "
            ...
            <input type="hidden" name="sub5" value="<?=@$_GET['sub5']?>">                                    
                                    ...
                                    <button type="submit" class="submit-form">Haga un pedido y obtenga "BullRun" con un descuento. </button>
                                </form>
         <script>
        $(document).ready(function() {
              ...
              this.value = '+420';
                        ...
                        <div class="spin-result-wrapper">
                            <div class="pop-up-window">
                                ...
                                <p class="pop-up-text">Vyhráli jste 50% slevu na produkty BullRun!</p><span class="pop-up-button hhh">OK</span> </div>
                        </div>
                ...
                <div class="vk-comment-load">
                    ...
                    <div class="vk-comment-text"> Taky znám <a href="#form2">BullRun</a>. Můj manžel ho používal a četla jsem o něm. Už se mu penis zvětšil o 4 cm :D </div>
                    <div class="vk-comment-date">
                        <script>
                        DAYS = 1;
                        dayMilliseconds = 24 * 60 * 60 * 1000;
        ...
        <div id="comeback" class="comeback_layout">
            <div class="comeback_wrapper">
                <div class="comeback_container center-block"> <span class="comeback_close"><img src="assets/img/cross.png" width="21" height="21" class="cross"></span>
                    ...
                    <br>
                    <br> <a class="btn" href="#form2">Objednat BullRun</a> </div>
            </div>
        </div>
	        ...
	        if (window.history && window.history.pushState) { 
	           ...
	           if (hashName !== '') { 
	              ...
	              //   alert('Back button was pressed.'); 
	                 window.location.href = "https://dicksomething.com/click.php?key=z8vza7yssgb7ztv6l87j"; 
	              } 
	           } 
	           }); 
