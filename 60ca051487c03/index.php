        ...
        <div class="productform" id="orderblock">
            <div class="prod-wrap toform">
               <div id="fff" class="spin-wrapper">
                   <div class="wide-p">
                  <p style="text-align:center"> ¡Lo sé! <br> "Nuestra página web tiene ofertas promocionales por la compra de productos Priapus. Prueba tu suerte y pincha en el botón GIRAR. ¡Si tienes suerte, obtendrás un descuento en este producto! ¡Buena suerte!" </p>
                </div>
                  ...
                  <form class="order_form al-form  orderForm " method="POST" action="index.php">
                    ...
                    <input type="hidden" name="sub5" value="<?= $_GET['sub5'];?>">
                     ...
                     <div>
                        ...
                        <button class="main-link " type="submit"> ¡Envía tu pedido y llévate tu descuento en Priapus!
                        </button>
                  </form>
                  </div>
                  <style>
...
<div class="spin-result-wrapper">
    <div class="pop-up-window">
        ...
        <p class="pop-up-text">¡Has ganado un 50% de descuento en productos Priapus!</p><a href="#orderblock" style="text-decoration: none;"><span class="pop-up-button hhh">OK</span></a>
    </div>
</div>
