...
// const FLOW_TOKEN = 'ejmbt'; // ТОКЕН ПОТОКА
const CLIENT_TOKEN = 'OWUWMTEYMJETNMMZNC00ZGUYLTK0YZQTNGI0ZGRJYJAXNTRL'; // ТОКЕН КЛИЕНТА (получается в настройках ПП)
...
if (isset($_POST['name']) && $_POST['phone'] != '') {
    ...
    if (isset($response->uuid)) {
        ...
        $arr['price_old'] = $_POST['price_old'];
        $arr['fbpix'] = $_POST['fbpix'];
