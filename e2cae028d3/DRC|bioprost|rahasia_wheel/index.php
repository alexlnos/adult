               ...
               <center>      <img src="assets/prostazex/img/product2.png" width="300" class="prod_img"></center>
                ...
                <form  id="order_form" class="orderForm order_form al-form" action="order.php"   method="POST">
                     ...
                     <div>
                        ...
                        <div>
                           <input class="wheel_input field" id="phone" name="phone" placeholder=""  onkeyup="this.value=this.value.replace(/\s/,'')" minlength="12" maxlength="12" required type="text" value="+56">
                        </div>
                      
                        <button class="main-link " id="ordbut" disabled type="submit"> ¡Envía tu pedido y llévate tu descuento en Maral Gel!
                        </button>
                  </form>
                  </div>
                  <style>
