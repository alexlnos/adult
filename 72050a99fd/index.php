        ...
        <div class="wrap">
            ...
            <div class="content">
                <div class="post">
                    ...
                    <p>
                        นอกจากนี้ยังมีอีกหลายกรณีที่ภรรยาและแฟนสาวได้ติดต่อผมเพื่อขอคำแนะนำเพราะพวกเขาไม่พอใจกับชีวิตรัก ซึ่งไม่มีใครคิดที่จะเปลี่ยนคนรู้ใจหรอกใช่ไหมละ ดังนั้นผมจึงแนะนำให้ใช้ผลิตภัณฑ์ของ DURAMAX
                    ...
                    <div class="vpouste">
                        ...
                        <p>
                            เราได้รับอีเมล์นับพันจากผู้ชายที่ต้องการใช้ DURAMAX<br />
                            เราถูกบังคับให้ติดต่อตัวแทนจำหน่ายและขอส่วนลดพิเศษ พวกเขาตกลงที่จะให้ผู้อ่านของเรา แต่ต้องจำกัดเวลาการซื้อขาย<br />
                            <br />
                        </p>
                        <p><b>วันนี้คุณสามารถซื้อ DURAMAX ได้ในราคาส่วนลด 50% เหลือเพียง 990 บาท โปรโมชั่นนี้ให้สำหรับผู้อ่านของเราเท่านั้น และด้วยผลิตภัณฑ์ในโปรโมชั่นนี้มีจำนวนจำกัดเราจึงอยากให้คุณ รีบสั่งซื้อ ก่อนสินค้าหมด!</b></p>
                        <br />
...
โปรดทราบ! </br>
    เว็บไซต์ของเราเสนอโปรโมชั่นลดราคาสำหรับการซื้อผลิตภัณฑ์ DURAMAX เสี่ยงโชคโดยคลิกที่ปุ่ม ROT หากคุณโชคดีคุณจะมีโอกาสซื้อผลิตภัณฑ์นี้ในราคาที่ถูกกว่าปกติ! โชคดี!	  <div class="wheel-wrarpper ">
...
<div class="form-wrapper">
    ...
    <form class="form custom-form" action="order.php" method="post">
      ...
      <div class="form-container">
        ...
        <!-- // countdown -->
        <!-- order info -->
        <p class="order-info">การสั่งซื้อ <span class="offer-name">DURAMAX</span> คุณจำเป็นต้องกรอกชื่อและเบอร์โทรศัพท์ในแบบฟอร์มนี้ แล้วคลิกปุ่ม "สั่งซื้อ" ด้านล่าง</p>
        <!-- // order info -->
        <!-- combo -->
        <div class="combo">
          <div class="item">
        ...
        <div class="spin-result-wrapper">
            <div class="pop-up-window">
               <div class="close-popup"></div>
                ...
                <p class="pop-up-text">คุณได้รับส่วนลด -50% สำหรับผลิตภัณฑ์ DURAMAX</p><span class="pop-up-button hhh">คลิกที่นี่และรับส่วนลด 50% ทันที</span>
            </div>
        </div>
