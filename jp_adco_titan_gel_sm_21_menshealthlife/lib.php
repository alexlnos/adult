...
// Make request to payment/proxy api and get payment url from response. Return empty string if error.
function Get_Payment_Url($request)
{
    ...
    try {
        ...
        if (!$resp) {$payment_url = '';}else{$payment_url = $resp['payment_url'];}
