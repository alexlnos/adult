        ...
        <div class="success-page__header">
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    <span>$name</span>, ご注文いただきありがとうございます。
                </h2>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text" style="text-align: center">ありがとう、情報が保存されました。</h3>
            </div>
        </div>
    </div>
</div>
EOV;
    ...
    if ($_REQUEST['payment_redirect'] and $data['code'] == 'ok') {
        if (!$data['is_double']) {
            $pixel_code = ACLandingConfig::PIXEL_CODE;
        }
        $payment_url = Get_Payment_Url($_REQUEST);
        if ($payment_url) {
            echo <<<EOV
<!DOCTYPE html>
<html>
            ...
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    ...
                    <p class="success-page__message_success">
                        ご注文は正常に処理されました！
                        <br>
                        ただいま商品の配送中です。正しい電話番号をご入力いただいていることを確認してください。担当者からお電話させていただきますので、その際に詳細をご確認ください。
                    </p>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text">連絡先情報を確認してください。</h3>
                <div class="list-info">
                    <ul class="list-info__list">
                        <li class="list-info__item">
                            <span class="list-info__text">電話番号: </span>
                            $phone
                        </li>
                    </ul>
                </div>
                ...
                <div class="form">
                    <form action="" class="success-page__form" name="update_form" id="details" method="post">
                        <div class="success-page__form__container">
                            ...
                            <div class="success-page__form__button" onclick="SubmitForm()"> 送信 </div>
                        </div>
                    </form>
                </div>
            </div>
...
function SubmitForm() {
    ...
    emptyFieldsMsg = "<span style='color: red'>電子メールおよび/またはアドレスが必要です!</span>" +
        "<br><br>必須情報をご入力ください。",
