...
<div class="form-wrapper">
    ...
    <form class="form custom-form">
      ...
      <div class="form-container">
        ...
        <!-- // countdown -->
        <!-- order info -->
        <p class="order-info">การสั่งซื้อ <span class="offer-name">[Product Name]</span> คุณจำเป็นต้องกรอกชื่อและเบอร์โทรศัพท์ในแบบฟอร์มนี้ แล้วคลิกปุ่ม "สั่งซื้อ" ด้านล่าง</p>
        <!-- // order info -->
        <!-- combo -->
        <div class="combo">
          <div class="item">
        ...
        <div class="form-elements">
          ...
          <div class="input-container">
            ...
            <input name="phone" id="phone" placeholder="" type="tel" value="+91" minlength="5" required>
