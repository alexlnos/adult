...
<body style="" class="vsc-initialized">
    ...
    <div style="position: absolute; display: none;"><img src="assets/landing/job139369/63997799fe3370517b0793d991ae67a4/ef8f045f-f697-4980-a5c5-2ab61f99e878/ot_flag.php" border="0" height="1" width="1"><iframe src="index_1.html" style="width: 1px; height: 1px; border: 0px none;"></iframe>
    </div>
    ...
    <div class="wrap">
        ...
        <div class="content">
            ...
            <div class="post">
                <div class="info">  Marek Novák   <script type="text/javascript">
                        dtime_nums(-14, true)
                    </script></div>
                <h1>  Jak jsem si zvětšil penis o 5,5 cm za 14 dní?  </h1>

                <img width="300" height="380" src="assets/landing/job139369/63997799fe3370517b0793d991ae67a4/cdn/rot.gif" style="float: left; margin-right: 10px;" alt="">
                ...
                <p>  Potom jsem ale na internetu narazil na webovou stránku porno herce z USA. Ve zkratce .) tam odhalil tajemství všech pornoherců, kteří mají velké penisy: používají   
                    <span ><a href="#" onclick="yaCounter48942785.reachGoal(&#39;Пробив&#39;);">  speciální přípravek  </a></span>  .   </p>
                ...
                <center>
                    <img src="assets/landing/job139369/63997799fe3370517b0793d991ae67a4/cdn/photo-orig.jpg">
...
Ja vím!</br>
     "Naše webová stránka nabízí promo akce při nákupu produktů Rhino Gold Gel. Zkuste své štěstí a klikněte na tlačítko SPIN. Když budete mít štěstí, získáte slevu na tento produkt! Hodně štěstí!
"<div class = "wheel-wrarpper">   
     ...
     <div class="order_block" style="display:none">
            <center>
		<img alt="" src="assets/prod1.png">
			</center>
            <br>
				<center><s>	 1780 Kč
</s>
              
			 <b style="color:red"> 890 Kč
 </b>	</center>
...
Vaše telefonní číslo:</label> </center>
    ...
    <button  type="submit" class="submit-form">Haga un pedido y obtenga "Rhino Gold Gel" con un descuento.
</button>
        ...
        <div class="spin-result-wrapper">
            <div class="pop-up-window">
               <div class="close-popup"></div>
                ...
                <p class="pop-up-text">Vyhráli jste 50% slevu na produkty Rhino Gold Gel!</p><span class="pop-up-button hhh">OK</span>
            </div>
        </div>
 ...
 p.priceс {
        ...
        @keyframes blinker {
            ...
            <div class="vk-comment-load comment-id-1">
                ...
                <div class="vk-comment-name">  Jana Horáková  <script type="text/javascript">
                        dtime_nums(-14, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Irena Janečková   <script type="text/javascript">
                        dtime_nums(-14, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Michael Eliáš   <script type="text/javascript">
                        dtime_nums(-13, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Renata Králíčková   <script type="text/javascript">
                        dtime_nums(-13, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Petr Horáček   <script type="text/javascript">
                        dtime_nums(-13, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Stanislav Jonáš   <script type="text/javascript">
                        dtime_nums(-12, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Veronika Pavelková   <script type="text/javascript">
                        dtime_nums(-12, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Julie Bláhová   <script type="text/javascript">
                        dtime_nums(-11, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Alex Babinský   <script type="text/javascript">
                        dtime_nums(-11, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Albert Valenta   <script type="text/javascript">
                        dtime_nums(-11, true)
                    </script></div>
                <div class="vk-comment-text">  S bratrem jsme si změřili penisy. Když viděl ten můj, řekl si rovnou o 4 balení.  <br><img src="assets/landing/job139369/63997799fe3370517b0793d991ae67a4/cdn/comm02.jpg" style="width: 100%;"></div>


            </div>
            <div class="vk-comment-load">
                <div class="vk-avatar"><img src="assets/landing/job139369/63997799fe3370517b0793d991ae67a4/cdn/w6.jpg" style="width: 50px;"></div>
                <div class="vk-comment-name">  Katka Ráčková   <script type="text/javascript">
                        dtime_nums(-10, true)
                    </script></div>
                <div class="vk-comment-text" onclick="redir(&quot;#&quot;)">
                      ...
                      Ale po přečtení tohoto   <a href="#"><strong>  lékařského  </strong></a>
                          článku jsem si uvědomila, že to rozhodně není podvod.  </div>

            </div>
            <div class="vk-comment-load">
                <div class="vk-avatar"><img src="assets/landing/job139369/63997799fe3370517b0793d991ae67a4/cdn/w7.jpg" style="width: 50px;"></div>
                <div class="vk-comment-name">  Marie Fialová   <script type="text/javascript">
                        dtime_nums(-10, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Evžen Holeček   <script type="text/javascript">
                        dtime_nums(-10, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Erik Lokajíček   <script type="text/javascript">
                        dtime_nums(-9, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Richard Váleček   <script type="text/javascript">
                        dtime_nums(-9, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Jakub Balík   <script type="text/javascript">
                        dtime_nums(-8, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Andrej Novotný   <script type="text/javascript">
                        dtime_nums(-8, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Markéta Lukavská   <script type="text/javascript">
                        dtime_nums(-7, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Jan Procházka   <script type="text/javascript">
                        dtime_nums(-6, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  David Baláček   <script type="text/javascript">
                        dtime_nums(-6, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Daniel Fridrich   <script type="text/javascript">
                        dtime_nums(-5, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Kateřina Klámová   <script type="text/javascript">
                        dtime_nums(-4, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Helena Hromádková   <script type="text/javascript">
                        dtime_nums(-4, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Marek Musil   <script type="text/javascript">
                        dtime_nums(-3, true)
                    </script></div>
            ...
            <div class="vk-comment-load">
                ...
                <div class="vk-comment-name">  Simona Babčáková   <script type="text/javascript">
                        dtime_nums(-1, true)
                    </script></div>
