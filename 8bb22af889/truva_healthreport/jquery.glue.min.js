    ...
    e.glue = function (n) {
        ...
        function a(t) {
            if (-1 == t.pageX && -1 == t.pageY) var n = -p + e(document).scrollTop(),
                a = r - e(document).scrollLeft(); else var n = -t.pageY + e(document).scrollTop(),
                a = t.pageX - e(document).scrollLeft();
            var l, g = -s / m * a, y = s / m * a - s;
        ...
        function c() {
            ...
            var customEvent = new Event("workaround");
        ...
        e(u.layer).hide();
        var r, d = (new Date).getTime(), s = e(window).height(), m = e(window).width(), g = !1, f = 0, v = 0, b = !0,
            p = 0;
        if (/Chrome/.test(navigator.userAgent)) {
            var h = !0;
            e(document).width() > m && 1 == u.disableleftscroll && (b = !1)
        }
        var y = parseFloat(e(u.layer).css("height")), x = parseFloat(e(u.layer).css("width")), w = {
