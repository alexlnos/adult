            ...
            <div class="post">
                <div style="line-height:inherit;letter-spacing:initial;float:initial;height:auto;">
                    <div class="zizou">
                        ...
                        <p>Používání tyto prášky <a href="#form2">Erosept</a> se nepojí s rizikem, jako v případě operace a užívání pilulek, a jeho vliv na zvětšení penisu a potence je jedinečný.</p>
...
.</b></p>
                        ...
                        <br>
                        <center>
                            <a href="#form2"><img class="lazy" data src="assets/img/product.png"></a>
                        </center>
                        <br>
            ...
            if(!this.value.match(/^\+420/g)) {
              this.value = '+420';
                ...
                <div class="vk-comment-load">
                    ...
                    <div class="vk-comment-text"> Taky znám <a href="#form2">Erosept</a>. Můj manžel ho používal a četla jsem o něm. Už se mu penis zvětšil o 4 cm :D </div>
                    <div class="vk-comment-date">
                        <script>
                        DAYS = 1;
                        dayMilliseconds = 24 * 60 * 60 * 1000;
        ...
        <div id="comeback" class="comeback_layout">
            <div class="comeback_wrapper">
                <div class="comeback_container center-block"> <span class="comeback_close"><img src="assets/img/cross.png" width="21" height="21" class="cross"></span>
                    ...
                    <br>
                    <br> <a class="btn" href="#form2">Objednat Erosept</a> </div>
            </div>
        </div>
