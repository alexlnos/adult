...
$(document).ready(function() {
  ...
  function changeImg(min, max) {
    ...
    $(".notification-popup").find("img").removeClass("fadeOutLeft-spop");
    $(".notification-popup-mbl").find("img").removeClass("fadeOutLeft-spop");
    $(".notification-popup").find("img").attr('src','images/notifications/' + ""+ numRand +"" + '.png').addClass("fadeInLeft-spop");
    $(".notification-popup-mbl").find("img").attr('src','images/notifications/' + ""+ numRand +"" + '.png').addClass("fadeInLeft-spop");

    setTimeout(function(){
      $(".notification-popup").find("img").removeClass("fadeInLeft-spop");
      $(".notification-popup-mbl").find("img").removeClass("fadeInLeft-spop");
      $(".notification-popup").find("img").addClass("fadeOutLeft-spop");
      $(".notification-popup-mbl").find("img").addClass("fadeOutLeft-spop");
    }, 5000);
